...
public class RPGToolMaterial implements IMaterialSpecial
{
    ...
    public static final RPGToolMaterial OBSIDIAN        = new RPGToolMaterial("obsidian",       EnumHelper.addToolMaterial("OBSIDIAN",     3, 2000,  8.0F,  5.0F,  12), 0xEAAC00, RPGItemRarity.rare);
    public static final RPGToolMaterial BEDROCK         = new RPGToolMaterial("bedrock",        EnumHelper.addToolMaterial("BEDROCK",      3, 4000,  12.0F, 11.0F, 14), 0x004400, RPGItemRarity.mythic);
    public static final RPGToolMaterial BLACK_MATTER    = new RPGToolMaterial("black_matter",   EnumHelper.addToolMaterial("BLACK_MATTER", 3, 8000,  18.0F, 21.0F, 19), 0x000000, RPGItemRarity.epic);
    public static final RPGToolMaterial WHITE_MATTER    = new RPGToolMaterial("white_matter",   EnumHelper.addToolMaterial("WHITE_MATTER", 3, 10000, 24.0F, 36.0F, 22), 0xffffff, RPGItemRarity.legendary);
