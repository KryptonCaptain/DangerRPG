...
public class ItemRPGArmor extends ItemArmor implements IRPGItemArmor, IHasBooksInfo
{
    ...
    public ItemRPGArmor(RPGArmorMaterial armorMaterial, RPGArmorComponent armorComponent, int renderIndex, int armorType)
    {
    ...
    {
        return new ItemRPGArmor[] {
            new ItemRPGArmor(armorMaterial, armorComponent, 0, 0),
