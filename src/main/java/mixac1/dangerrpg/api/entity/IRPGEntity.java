...
public interface IRPGEntity
{
    ...
    public void registerAttributes(Class<? extends EntityLivingBase> entityClass, EntityAttributesSet set);
    ...
    public static IRPGEntity DEFAULT_PLAYER = new IRPGEntity()
    {
        ...
        public void registerAttributes(Class<? extends EntityLivingBase> entityClass, EntityAttributesSet set)
        {
            RPGEntityData.registerEntityPlayer((Class<? extends EntityPlayer>) entityClass, set);
        }
    };
    ...
    public static class RPGLivingEntity implements IRPGEntity
    {
        ...
        public void registerAttributes(Class<? extends EntityLivingBase> entityClass, EntityAttributesSet set)
        {
            RPGEntityData.registerEntityLiving((Class<? extends EntityLiving>) entityClass, set);
        }
    };
    ...
    public static class RPGDefaultEntityMob extends RPGLivingEntity
    {
        ...
        public void registerAttributes(Class<? extends EntityLivingBase> entityClass, EntityAttributesSet set)
        {
            ...
            RPGEntityData.registerEntityMob((Class<? extends EntityMob>) entityClass, set);
        }
    };
