...
public class EntityAttributes
{
    ...
    public static final EAWithIAttr     HEALTH             = new EAHealth        ("health",       RPGUUIDs.MOD_HEALTH_DAMAGE, SharedMonsterAttributes.maxHealth);
    public static final EAWithIAttr     MELEE_DAMAGE       = new EAWithExistIAttr("melee_damage", RPGUUIDs.MOD_MELEE_DAMAGE,  SharedMonsterAttributes.attackDamage);
