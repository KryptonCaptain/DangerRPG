...
public class RPGOther
{
    ...
    {
        public static EnumRarity common = EnumHelper.addRarity("common", TextFormatting.WHITE, "Common");

        public static EnumRarity uncommon = EnumHelper.addRarity("uncommon", TextFormatting.GREEN, "Uncommon");

        public static EnumRarity rare = EnumHelper.addRarity("rare", TextFormatting.BLUE, "Rare");

        public static EnumRarity mythic = EnumHelper.addRarity("mythic", TextFormatting.DARK_PURPLE, "Mythic");

        public static EnumRarity epic = EnumHelper.addRarity("epic", TextFormatting.DARK_RED, "Epic");
