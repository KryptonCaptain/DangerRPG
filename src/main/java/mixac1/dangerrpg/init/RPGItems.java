...
public class RPGItems
{
    ...
    public static Item[] armorObsidian    = RPGItemArmor.createFullSet(RPGArmorMaterial.OBSIDIAN,     "armor_obsidian");
    public static Item[] armorBedrock     = RPGItemArmor.createFullSet(RPGArmorMaterial.BEDROCK,      "armor_bedrock");
    public static Item[] armorBlackMatter = RPGItemArmor.createFullSet(RPGArmorMaterial.BLACK_MATTER, "armor_black_matter");
    public static Item[] armorWhiteMatter = RPGItemArmor.createFullSet(RPGArmorMaterial.WHITE_MATTER, "armor_white_matter");

    public static Item[] mageArmorTest = ItemMageArmor.createFullSet(RPGArmorMaterial.WHITE_MATTER, "mage_armor_test");
    ...
    private static void registerItems()
    {
        ...
        registerItemArray(mageArmorTest);
